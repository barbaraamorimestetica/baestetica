...
Atenção às classes que só existem dentro de JavaScript:

- strings de `innerHTML` (ex.: o cartão alternativo em `Resultados.html`)
- `classList.add()` / `classList.remove()` (ex.: o toast em `catalogo.html`)
